...
bool Nova::runOnModule(Module &M) {
    ...
    // f = M.getFunction("_ZN6Copter9fast_loopEv");
    if (f == NULL)
        errs() << "f is NULL!" <<"\n";
...
void Nova::InstrumentStoreInst(Instruction *inst, Value *addr, Value *val) {
    ...
    Constant *RecordDefEvt = M->getOrInsertFunction("__test", VoidTy,
                                                                      I64Ty,
                                                                      I64Ty, 
                                                                      nullptr);
    ...
    Function *RecordDefEvtFunc = cast<Function>(RecordDefEvt);
    RecordDefEvtFunc->addAttribute(AttributeSet::FunctionIndex, Attribute::NoInline);
...
void Nova::InstrumentLoadInst(Instruction *inst, Value *addr, Value *val) {
    ...
    Constant *CheckUseEvt = M->getOrInsertFunction("__test", VoidTy,
                                                                     I64Ty,
                                                                     I64Ty, 
                                                                     nullptr);
    ...
    CheckUseEvtFunc->addAttribute(AttributeSet::FunctionIndex, Attribute::NoInline);
