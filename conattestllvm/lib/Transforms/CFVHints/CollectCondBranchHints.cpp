...
struct  CollectCondBranchHints : public FunctionPass {
  ...
  bool runOnFunction(Function &F) override {
    ...
    // if(name != "_ZN11GCS_MAVLINK12send_messageE10ap_message"){
    //   return false;
    // }

    if(name == "view_switch_to_rd_and_log"){
      return false;
    }
...
bool CollectCondBranchHints::instrumentCondBranch(Instruction *I, Value *cond) {
    ...
    Constant *ConstCollectCondBranchHints= M->getOrInsertFunction("__conditional_branch_recording", VoidTy,
                                                                     I1Ty, 
                                                                     nullptr);
