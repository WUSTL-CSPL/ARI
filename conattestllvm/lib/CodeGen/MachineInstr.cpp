...
void MachineInstr::addOperand(MachineFunction &MF, const MachineOperand &Op) {
  ...
  // errs() << "------------S-------------\n";
  // errs() << "isImpReg: " << isImpReg << "\n";
  // errs() << "OP.isImpReg(): " << Op.isRegMask() << "\n";
  // errs() << "MCID->isVariadic(): " << MCID->isVariadic() << "\n";
  // errs() << "MCID Opcode: " << MCID->getOpcode() << "\n";
  // errs() << "OpNo: "<< OpNo << " MCID->getNumOperands:" << MCID->getNumOperands() <<" OpNo < MCID->getNumOperands(): " << (OpNo < MCID->getNumOperands()) << "\n";
  // errs() << "Optype: " << Op.getType() << "\n";
  // errs() << "isMetaDataOp: " << isMetaDataOp << "\n";
  // errs() << "resutl: " << (isImpReg || Op.isRegMask() || MCID->isVariadic() || OpNo < MCID->getNumOperands() || isMetaDataOp) << "\n";
  // errs() << "------------E-------------\n";
